...
INSERT INTO `categoria` VALUES (1,'Informatica'),(2,'Escriorio'),(3,'Cama mesa e banho'),(4,'Eletrônicos'),(5,'Jardinagem'),(6,'Decoração'),(7,'Perfumaria');
...
CREATE TABLE `cliente` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cpfocnpj` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de escritório',300),(5,'Toalha',50),(6,'Colcha',200),(7,'TV true color',1200),(8,'Roçadeira',800),(9,'Abajour',100),(10,'Pendete',180),(11,'Shampoo',90);
...
-- Dump completed on 2020-11-16 20:19:03
